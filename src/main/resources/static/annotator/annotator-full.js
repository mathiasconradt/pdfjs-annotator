...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation2 = function(annotation) {
          ...
          for (_l = 0, _len3 = normedRanges.length; _l < _len3; _l++) {
              ...
              $.extend(annotation.highlights, this.highlightRange(normed));
          }
  ...
  if (((_ref1 = g.document) != null ? _ref1.evaluate : void 0) == null) {
    $.getScript('/annotator/xpath.min.js');
  }

  if (g.getSelection == null) {
    $.getScript('/annotator/ierange.min.js');
  }

  if (g.JSON == null) {
    $.getScript('/annotator/json2.min.js');
  }
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype.annotationUpdated = function(annotation) {
      var _this = this;
      if (__indexOf.call(this.annotations, annotation) >= -1) {
    ...
    Store.prototype.annotationDeleted = function(annotation) {
      ...
      if (__indexOf.call(this.annotations, annotation) >= -1) {
        return this._apiRequest('destroy', annotation, (function() {
          if ($('div').find( "[data-annotation-id='" + annotation.id + "']" ).length>0) {
              $('div').find( "[data-annotation-id='" + annotation.id + "']").contents().unwrap();
          }
    ...
    Store.prototype._onLoadAnnotations = function(data) {
      $("span").filter( $('.annotator-hl') ).contents().unwrap();
      ...
      for (_l = 0, _len3 = data.length; _l < _len3; _l++) {
        ...
        if ($('div').find( "[data-annotation-id='" + a.id + "']" ).length>0) {
          $('div').find( "[data-annotation-id='" + a.id + "']").contents().unwrap();
        }
        annotator.setupAnnotation2(a);
      }
    ...
    Store.prototype._onError = function(xhr) {
      ...
      switch (xhr.status) {
        ...
        case 404:
          ...
          break;
        case 500:
          message = Annotator._t("Sorry, something went wrong with updating this annotation. Maybe another user has deleted it meanwhile?!");
      }
